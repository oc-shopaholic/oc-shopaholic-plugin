<?php return [
    ...
    'button'      => [
        ...
        'import_product_from_xml'  => 'Import products from XML',
        'import_category_from_xml' => 'Import categories from XML',
        'import_brand_from_xml'    => 'Import brands from XML',
        'import_offer_from_csv'    => 'Import offers from CSV',
        'import_product_from_csv'  => 'Import products from CSV',
        'import_category_from_csv' => 'Import categories from CSV',
        'import_brand_from_csv'    => 'Import brands from CSV',
    ],
    'widget'      => [
        'import_from_xml_files' => 'Import from XML files',
        'import_from_csv_files' => 'Import from CSV files',
    ],
];
