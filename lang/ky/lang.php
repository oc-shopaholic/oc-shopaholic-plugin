<?php return [
    ...
    'component'   => [
        ...
        'sorting_date_begin_asc'       => 'Башталган датасы(көбөйүсү боюнча)',
        'sorting_date_begin_desc'      => 'Башталган датасы(азаюусу боюнча)',
        'sorting_date_end_asc'         => 'Бүткөн датасы(көбөйүсү боюнча)',
        'sorting_date_end_desc'        => 'Бүткөн датасы(азаюусу боюнча)',
    ],
    'permission'  => [
        'category'    => 'Категорияларды башкаруу',
        'brand'       => 'Брендттерди башкаруу',
        'product'     => 'Буюмдарды башкаруу',
        'settings'    => 'Орнотууларды башкаруу',
        'promo_block' => 'Жарнама тозмолорун башкаруу',
    ],
    'message'     => [
        'import_additional_category_info' => 'Кошумча буюм категорияларынын тизмесин үтүр менен бөлүңүз',
    ],
    'button'      => [
        'import_offer_button' => 'CSVдан сунуштарды импорттоо',
    ],
];
