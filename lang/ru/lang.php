<?php return [
    ...
    'button'      => [
        ...
        'import_offer_from_xml'    => 'Импорт торговых предложений из XML',
        'import_price_from_xml'    => 'Импорт цен из XML',
        'import_product_from_xml'  => 'Импорт товаров из XML',
        'import_category_from_xml' => 'Импорт категорий из XML',
        'import_brand_from_xml'    => 'Импорт брендов из XML',
        'import_offer_from_csv'    => 'Импорт торговых предложений из CSV',
        'import_product_from_csv'  => 'Импорт товаров из CSV',
        'import_category_from_csv' => 'Импорт категорий CSV',
        'import_brand_from_csv'    => 'Импорт брендов из CSV',
    ],
    'widget'      => [
