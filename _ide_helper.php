 ...
 * Generated for Laravel 5.1.46 (LTS) on 2017-07-15.
 *
...
namespace Lovata\Buddies\Facades {
    ...
    class BuddiesAuth {
         ...
         * @static 
         */
        public static function authenticate($arCredentials, $bRemember = true)
        {
            \Lovata\Buddies\Classes\BuddiesAuthManager::authenticate($arCredentials, $bRemember);
        }
         ...
         * in the session.
         *
         * @param \Lovata\Buddies\Classes\User $obUser
         * @param bool $bRemember
         * @static 
         */
        public static function login($obUser, $bRemember = true)
        {
            return \Lovata\Buddies\Classes\BuddiesAuthManager::login($obUser, $bRemember);
        }
         ...
         * @return null|\Lovata\Buddies\Classes\Throttle 
         * @static 
         */
        public static function findThrottleByLogin($sLoginName, $ipAddress)
        {
            return \Lovata\Buddies\Classes\BuddiesAuthManager::findThrottleByLogin($sLoginName, $ipAddress);
        }
         ...
         *
         * @param string $sLogin
         * @return \Lovata\Buddies\Classes\User|null 
         * @static 
         */
        public static function findUserByLogin($sLogin)
        {
            return \Lovata\Buddies\Classes\BuddiesAuthManager::findUserByLogin($sLogin);
        }
         ...
         * @return null|\Lovata\Buddies\Classes\User 
         * @static 
         */
        public static function findUserByCredentials($arCredentials)
        {
            return \Lovata\Buddies\Classes\BuddiesAuthManager::findUserByCredentials($arCredentials);
        }
         ...
         * @param array $arCredentials
         * @param $bActive
         * @return \Lovata\Buddies\Classes\User 
         * @static 
         */
        public static function register($arCredentials, $bActive = false)
        {
            return \Lovata\Buddies\Classes\BuddiesAuthManager::register($arCredentials, $bActive);
        }
        ...
        {
            //Method inherited from \October\Rain\Auth\Manager            
            return \Lovata\Buddies\Classes\BuddiesAuthManager::createUserModel();
        }
        ...
        {
            //Method inherited from \October\Rain\Auth\Manager            
            \Lovata\Buddies\Classes\BuddiesAuthManager::extendUserQuery($query);
        }
        ...
        {
            //Method inherited from \October\Rain\Auth\Manager            
            return \Lovata\Buddies\Classes\BuddiesAuthManager::setUser($user);
        }
        ...
        {
            //Method inherited from \October\Rain\Auth\Manager            
            return \Lovata\Buddies\Classes\BuddiesAuthManager::getUser();
        }
        ...
        {
            //Method inherited from \October\Rain\Auth\Manager            
            return \Lovata\Buddies\Classes\BuddiesAuthManager::findUserById($id);
        }
        ...
        {
            //Method inherited from \October\Rain\Auth\Manager            
            return \Lovata\Buddies\Classes\BuddiesAuthManager::createThrottleModel();
        }
        ...
        {
            //Method inherited from \October\Rain\Auth\Manager            
            return \Lovata\Buddies\Classes\BuddiesAuthManager::findThrottleByUserId($userId, $ipAddress);
        }
        ...
        {
            //Method inherited from \October\Rain\Auth\Manager            
            return \Lovata\Buddies\Classes\BuddiesAuthManager::check();
        }
        ...
        {
            //Method inherited from \October\Rain\Auth\Manager            
            return \Lovata\Buddies\Classes\BuddiesAuthManager::logout();
        }
...
namespace {
    ...
    class BuddiesAuth extends \Lovata\Buddies\Facades\BuddiesAuth {}
